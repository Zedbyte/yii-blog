...
<div class="bg-[#fffef7] dark:bg-stone-900 pt-3 pb-6 px-6 rounded-lg shadow-md border border-gray-300 dark:border-gray-700 w-3xl mx-auto mb-5">

    <div class="flex justify-end mb-5">
        <a href="<?php echo CHtml::normalizeUrl(array('view', 'id' => $data->id)); ?>" 
        class="text-stone-500 dark:text-stone-100 hover:text-stone-700 transition-all flex items-center space-x-1">
    ...
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Comment No. <?php echo CHtml::encode($data->id); ?></h2>
    ...
    <!-- Comment Content -->
    <p class="text-gray-700 dark:text-gray-100 mb-4 border-l-4 border-blue-500 pl-4">
