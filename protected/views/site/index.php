...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full h-full items-center text-center px-10">
    ...
    <div class="text-left space-y-6 md:space-y-8 lg:space-y-10">
        <h1 class="text-5xl sm:text-6xl md:text-7xl lg:text-9xl font-bold text-black dark:text-gray-200 text-nowrap font-rampart">
            Angeles<br />Secret Files
        </h1>
        <p class="text-lg sm:text-xl md:text-2xl text-gray-900 font-playpen dark:text-gray-200">
            A place to read, write, and laugh out loud.
        </p>
        <a href="/post" class="bg-stone-900 text-white dark:bg-gray-200 dark:text-stone-800 px-6 sm:px-8 md:px-10 py-2 sm:py-3 rounded-full text-base sm:text-lg md:text-xl 
