...
<div class="grid grid-cols-1 lg:grid-cols-12 relative">
	...
	<div class="span-5 last col-span-2 py-6 sticky right-0 top-0 h-fit">
		<div id="sidebar" class=" w-64 bg-[#fffef7] dark:bg-stone-900 shadow-lg border-l border-stone-300 dark:border-stone-700 p-6 rounded-lg space-y-8">
			<!-- 🔖 Sort by Tags -->
			<div>
				<h2 class="text-lg font-semibold text-stone-700 dark:text-stone-100 flex items-center space-x-2 mb-3">
